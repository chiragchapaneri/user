...
import { CreateEventValidationSchema } from "../../utils/FormValidations";
...
const Create = () => {
  ...
  }, [childCategories, schema, image, location, locationOptions, eventTags]);
      ...
      <Formik
        ...
        onSubmit={(values) => {
          ...
          location?.lat &&
            fData.append(
              "latitude",
              locationOptions ? "" : location?.lat || ""
            );
          location?.lng &&
            fData.append(
              "longitude",
              locationOptions ? "" : location?.lng || ""
            );
          location?.placeId &&
            fData.append(
              "placeId",
              locationOptions ? "" : location?.placeId || ""
            );
