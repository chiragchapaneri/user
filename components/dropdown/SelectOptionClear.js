          ...
          >
            <Listbox.Options
              className={classNames(
                ...
                "max-h-145 absolute mt-1 w-full overflow-auto rounded-md bg-white text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-[3] flex flex-col gap-10 cursor-pointer p-10"
              )}
            >
...
export default SelectOptionClear;
